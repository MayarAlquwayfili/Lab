...
struct SampleData {
    static func insertSampleData(context: ModelContext) {
        ...
        let wins = [
            ...
            Win(title: "SUNRISE", imageData: img("img_sunrise"), logTypeIcon: "sparkle.magnifyingglass", date: exactDate("22/07/2024"), environment: "mountain.2.fill", tools: "ic_WithoutTools", timeframe: "1D", collectionName: "Gazza!", collection: gazzaColl, notes: "I forced my fam to wake up 4 this on vacation. watching the sun hit the water was magical.", icon: "sunrise.fill"),
            ...
            Win(title: "TRADING", imageData: img("img_trading"), logTypeIcon: "sparkle.magnifyingglass", date: exactDate("15/06/2023"), environment: "house.fill", tools: "hammer.fill", timeframe: "+30D", collectionName: "Gazza!", collection: gazzaColl, notes: "It was such an incredible experience!", icon: "chart.bar.xaxis.ascending"),
